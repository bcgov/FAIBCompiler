test_that("logAdjustment.R: log length is not correctly adjusted.", {
  ...
  # print(testtreedata[,.(BTOP, HEIGHT, HT_TOTAL, NO_LOGS, LOG_L_1, LOG_L_2)])
  #     BTOP HEIGHT HT_TOTAL NO_LOGS LOG_L_1 LOG_L_2
  ...
  expect_equal(treedata_adjusted[,.(BTOP, HEIGHT, HT_TOTAL, NO_LOGS, LOG_L_1, LOG_L_2,
                                    LOGADJUST, LOG_L_0)],
  ...
  ## print(testtreedata)
  #     BTOP HEIGHT HT_TOTAL NO_LOGS LOG_L_1 LOG_L_2 LOG_L_3
  ...
  treedata_adjusted <- logAdjustment(treeData = testtreedata)
  # print(treedata_adjusted[order(uniObs),.(uniObs, HEIGHT, HT_TOTAL, NO_LOGS, LOG_L_0, LOG_L_1,
  #                                         LOG_L_2, LOG_L_3)])
  # uniObs HEIGHT HT_TOTAL NO_LOGS LOG_L_0 LOG_L_1 LOG_L_2 LOG_L_3
  ...
  expect_equal(treedata_adjusted[order(uniObs),.(HEIGHT, HT_TOTAL, NO_LOGS, LOG_L_0, LOG_L_1,
                                                 LOG_L_2, LOG_L_3)],
  ...
  #      uniObs HEIGHT HT_TOTAL NO_LOGS LOG_L_0 LOG_L_1 LOG_L_2 LOG_L_3 LOG_L_4
  ...
  expect_equal(treedata_adjusted[order(uniObs),.(BTOP, HEIGHT, HT_TOTAL, NO_LOGS, LOG_L_0, LOG_L_1,
                                                 LOG_L_2, LOG_L_3, LOG_L_4)],
  ...
  testtreedata <- data.table(uniObs = 1:2,
                             ...
                             LOG_L_3 = c(NA, NA))
  # print(testtreedata)
  #     uniObs BTOP HEIGHT HT_TOTAL NO_LOGS LOG_L_1 LOG_L_2 LOG_L_3
  ...
  #    uniObs HEIGHT HT_TOTAL NO_LOGS LOG_L_0 LOG_L_1 LOG_L_2 LOG_L_3     LOGADJUST
