...
This is frozen version (version 1.0000) of ISMC compiler as of July 2022. In this version, the PSP compilation and nonPSP compilation are implemented using two different functions.   
