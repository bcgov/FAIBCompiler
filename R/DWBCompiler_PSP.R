...
#' @export
#' @docType methods
#' @rdname DWBCompiler_PSP
#'
#' @author Yong Luo
#'
setGeneric("DWBCompiler_PSP",
           function(treeMS, siteAge, treeLossFactors, equation) {
             standardGeneric("DWBCompiler_PSP")
           })
...
setMethod(
  ...
  definition = function(treeMS, siteAge, treeLossFactors, equation){
    ...
    set(tree_rsk, , names(treeMS)[names(tree_rsk) %in% names(treeMS)], NULL)
...
setMethod(
  ...
  definition = function(treeMS, siteAge, treeLossFactors){
    return(DWBCompiler_PSP(treeMS, siteAge, treeLossFactors, equation = "KBEC"))
  })
